...
// module
exports.push([module.i, ".active[data-transition=\"0.1\"] p {\n  transition: transform 0.1s; }\n\n.active[data-transition=\"0.2\"] p {\n  transition: transform 0.2s; }\n\n.active[data-transition=\"0.3\"] p {\n  transition: transform 0.3s; }\n\n.active[data-transition=\"0.4\"] p {\n  transition: transform 0.4s; }\n\n.active[data-transition=\"0.5\"] p {\n  transition: transform 0.5s; }\n\n.active[data-transition=\"0.6\"] p {\n  transition: transform 0.6s; }\n\n.active[data-transition=\"0.7\"] p {\n  transition: transform 0.7s; }\n\n.active[data-transition=\"0.8\"] p {\n  transition: transform 0.8s; }\n\n.active[data-transition=\"0.9\"] p {\n  transition: transform 0.9s; }\n\n.active[data-transition=\"1\"] p {\n  transition: transform 1s; }\n\n.active[data-transition=\"1.1\"] p {\n  transition: transform 1.1s; }\n\n.active[data-transition=\"1.2\"] p {\n  transition: transform 1.2s; }\n\n.active[data-transition=\"1.3\"] p {\n  transition: transform 1.3s; }\n\n.active[data-transition=\"1.4\"] p {\n  transition: transform 1.4s; }\n\n.active[data-transition=\"1.5\"] p {\n  transition: transform 1.5s; }\n\n.active[data-transition=\"1.6\"] p {\n  transition: transform 1.6s; }\n\n.active[data-transition=\"1.7\"] p {\n  transition: transform 1.7s; }\n\n.active[data-transition=\"1.8\"] p {\n  transition: transform 1.8s; }\n\n.active[data-transition=\"1.9\"] p {\n  transition: transform 1.9s; }\n\n.active[data-transition=\"2\"] p {\n  transition: transform 2s; }\n\n.active[data-transition=\"2.1\"] p {\n  transition: transform 2.1s; }\n\n.active[data-transition=\"2.2\"] p {\n  transition: transform 2.2s; }\n\n.active[data-transition=\"2.3\"] p {\n  transition: transform 2.3s; }\n\n.active[data-transition=\"2.4\"] p {\n  transition: transform 2.4s; }\n\n.active[data-transition=\"2.5\"] p {\n  transition: transform 2.5s; }\n\n.active[data-transition=\"2.6\"] p {\n  transition: transform 2.6s; }\n\n.active[data-transition=\"2.7\"] p {\n  transition: transform 2.7s; }\n\n.active[data-transition=\"2.8\"] p {\n  transition: transform 2.8s; }\n\n.active[data-transition=\"2.9\"] p {\n  transition: transform 2.9s; }\n\n.active[data-transition=\"3\"] p {\n  transition: transform 3s; }\n\n.active[data-transition=\"3.1\"] p {\n  transition: transform 3.1s; }\n\n.active[data-transition=\"3.2\"] p {\n  transition: transform 3.2s; }\n\n.active[data-transition=\"3.3\"] p {\n  transition: transform 3.3s; }\n\n.active[data-transition=\"3.4\"] p {\n  transition: transform 3.4s; }\n\n.active[data-transition=\"3.5\"] p {\n  transition: transform 3.5s; }\n\n.active[data-transition=\"3.6\"] p {\n  transition: transform 3.6s; }\n\n.active[data-transition=\"3.7\"] p {\n  transition: transform 3.7s; }\n\n.active[data-transition=\"3.8\"] p {\n  transition: transform 3.8s; }\n\n.active[data-transition=\"3.9\"] p {\n  transition: transform 3.9s; }\n\n.active[data-transition=\"4\"] p {\n  transition: transform 4s; }\n\n.active[data-transition=\"4.1\"] p {\n  transition: transform 4.1s; }\n\n.active[data-transition=\"4.2\"] p {\n  transition: transform 4.2s; }\n\n.active[data-transition=\"4.3\"] p {\n  transition: transform 4.3s; }\n\n.active[data-transition=\"4.4\"] p {\n  transition: transform 4.4s; }\n\n.active[data-transition=\"4.5\"] p {\n  transition: transform 4.5s; }\n\n.active[data-transition=\"4.6\"] p {\n  transition: transform 4.6s; }\n\n.active[data-transition=\"4.7\"] p {\n  transition: transform 4.7s; }\n\n.active[data-transition=\"4.8\"] p {\n  transition: transform 4.8s; }\n\n.active[data-transition=\"4.9\"] p {\n  transition: transform 4.9s; }\n\n.active[data-transition=\"5\"] p {\n  transition: transform 5s; }\n\n.active[data-color=\"white\"] {\n  color: #fff; }\n\n.active[data-bg=\"white\"] {\n  background: #fff; }\n\n.active[data-color=\"black\"] {\n  color: #000; }\n\n.active[data-bg=\"black\"] {\n  background: #000; }\n\nhtml,\nbody {\n  position: relative;\n  overflow: hidden;\n  width: 100%;\n  height: 100%;\n  margin: 0;\n  font-family: Arial, Helvetica, sans-serif;\n  color: #000;\n  background: #fff; }\n\ndiv {\n  position: absolute;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  font-size: 0;\n  text-align: center; }\n  div.active p {\n    font-size: 10vmin; }\n  div:after {\n    display: inline-block;\n    height: 100%;\n    vertical-align: middle;\n    content: \"\"; }\n  div p {\n    display: inline-block;\n    margin: 0;\n    white-space: pre-wrap;\n    vertical-align: middle;\n    font-size: 0; }\n\n#reStart {\n  position: fixed;\n  top: 0;\n  right: 0;\n  font-size: 5vmin;\n  border: 2px solid #000;\n  background: #fff; }\n  .active + #reStart {\n    display: block; }\n\n#stop {\n  position: fixed;\n  top: 0;\n  left: 0;\n  font-size: 5vmin;\n  border: 2px solid #000;\n  background: #fff; }\n", "", {"version":3,"sources":["/Users/uiwwnwyoon/work/s_animation/src/src/_ani.scss","/Users/uiwwnwyoon/work/s_animation/src/src/style.scss"],"names":[],"mappings":"AAAA;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,yBAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,yBAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,yBAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,yBAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,2BAA6B,EAChC;;AANb;EAKgB,yBAA6B,EAChC;;AANb;EAcY,YAJmB,EAKtB;;AAfT;EAkBY,iBARmB,EAStB;;AAnBT;EAcY,YAJoC,EAKvC;;AAfT;EAkBY,iBARoC,EASvC;;ACjBT;;EAEI,mBAAkB;EAClB,iBAAgB;EAChB,YAAW;EACX,aAAY;EACZ,UAAS;EACT,0CAAyC;EACzC,YAAW;EACX,iBAAgB,EACnB;;AAED;EACI,mBAAkB;EAClB,OAAM;EACN,SAAQ;EACR,UAAS;EACT,QAAO;EACP,aAAY;EACZ,mBAAkB,EAsBrB;EA7BD;IAWY,kBAAiB,EACpB;EAZT;IAgBQ,sBAAqB;IACrB,aAAY;IACZ,uBAAsB;IACtB,YAAW,EACd;EApBL;IAuBQ,sBAAqB;IACrB,UAAS;IACT,sBAAqB;IACrB,uBAAsB;IACtB,aAAY,EACf;;AAGL;EACI,gBAAe;EACf,OAAM;EACN,SAAQ;EAER,iBAAgB;EAChB,uBAAsB;EACtB,iBAAgB,EAKnB;EAHG;IACI,eAAc,EACjB;;AAGL;EACI,gBAAe;EACf,OAAM;EACN,QAAO;EACP,iBAAgB;EAChB,uBAAsB;EACtB,iBAAgB,EACnB","file":"style.scss","sourcesContent":[".active {\n    @for $i from 1 through 50 {\n        $v : $i / 10;\n        &[data-transition=\"#{$v}\"]{\n            p {\n                transition: transform #{$v}s;\n            }\n        }\n    }\n\n    $theme-list: (\"white\", #fff), (\"black\", #000);\n\n    @each $name, $color in $theme-list {\n        &[data-color=\"#{$name}\"]{\n            color: $color;\n        }\n\n        &[data-bg=\"#{$name}\"]{\n            background: $color;\n        }\n    }\n\n    // @for $i from 3 through 10 {\n    //     &[data-ex-transform=\"scale(#{$i})\"] {\n    //         transform: scale(#{$i});\n    //     }\n    // } \n    // @for $i from 1 through 20 {\n    //     $j: $i / 10;\n    //     &[data-ex-transform=\"scale(#{$j})\"] {\n    //         transform: scale(#{$j});\n    //     }\n    // }\n    // @for $i from -5 through 5 {\n    //     $i: $i * 10;\n    //     &[data-ex-transform=\"skewX(#{$i}deg)\"] {\n    //         transform: skewX(#{$i}deg);\n    //     }\n    //     &[data-ex-transform=\"skewY(#{$i}deg)\"] {\n    //         transform: skewY(#{$i}deg);\n    //     }\n    // }\n    // @for $i from -36 through 36 {\n    //     $i: $i * 10;\n    //     &[data-ex-transform=\"rotate(#{$i}deg)\"] {\n    //         transform: rotate(#{$i}deg);\n    //     }\n    // }\n\n    // @for $i from -20 through 20 {\n    //     $i: $i;\n    //     &[data-ex-left=\"#{$i}%\"] {\n    //         left: $i+%;\n    //     }\n    // }\n\n    // @for $i from -20 through 20 {\n    //     $i: $i;\n    //     &[data-ex-top=\"#{$i}%\"] {\n    //         top: $i+%;\n    //     }\n    // }\n}","@charset \"utf-8\";\n@import \"_ani\";\nhtml,\nbody {\n    position: relative;\n    overflow: hidden;\n    width: 100%;\n    height: 100%;\n    margin: 0;\n    font-family: Arial, Helvetica, sans-serif;\n    color: #000;\n    background: #fff;\n}\n\ndiv {\n    position: absolute;\n    top: 0;\n    right: 0;\n    bottom: 0;\n    left: 0;\n    font-size: 0;\n    text-align: center;\n\n    &.active {\n        p {\n            font-size: 10vmin;\n        }\n    }\n\n    &:after {\n        display: inline-block;\n        height: 100%;\n        vertical-align: middle;\n        content: \"\";\n    }\n\n    p {\n        display: inline-block;\n        margin: 0;\n        white-space: pre-wrap;\n        vertical-align: middle;\n        font-size: 0;\n    }\n}\n\n#reStart {\n    position: fixed;\n    top: 0;\n    right: 0;\n    // display: none;\n    font-size: 5vmin;\n    border: 2px solid #000;\n    background: #fff;\n\n    .active + & {\n        display: block;\n    }\n}\n\n#stop {\n    position: fixed;\n    top: 0;\n    left: 0;\n    font-size: 5vmin;\n    border: 2px solid #000;\n    background: #fff;\n}"],"sourceRoot":""}]);
